...
-- Este script calcula las horas hombre basándose en los datos existentes

-- 1. Verificar datos existentes antes de la migración
SELECT 
...
-- 3. Verificar datos después de la migración
SELECT 
